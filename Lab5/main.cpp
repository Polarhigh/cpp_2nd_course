...
1. Ќаписать программу, котора€ выполн€ет следующие действи€:
 - «аполн€ет vector<DataStruct> структурами DataStruct, при этом key1 и key2, генерируютс€ случайным образом в диапазоне от -5 до 5, str заполн€етс€ из таблицы (таблица содержит 10 произвольных строк, индекс строки генерируетс€ случайным образом)
 - ¬ыводит полученный вектор на печать
 - —ортирует вектор следующим образом:
  * ѕо возрастанию key1
  * ≈сли key1 одинаковые, то по возрастанию key2
  * ≈сли key1 и key2 одинаковые, то по возрастанию длинны строки str
 - ¬ыводит полученный вектор на печать
*/
